 ...
 */
final class Version20260223101601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, date_naissance DATE NOT NULL, telephone VARCHAR(30) NOT NULL, code VARCHAR(50) NOT NULL, sexe VARCHAR(20) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, groupe_sanguin VARCHAR(10) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, username VARCHAR(180) NOT NULL, hash_password VARCHAR(255) NOT NULL, statut BOOLEAN NOT NULL, roles JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, service_medical_id INT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('ALTER TABLE dossier_medical ADD CONSTRAINT FK_3581EE626B899279 FOREIGN KEY (patient_id) REFERENCES patient (id) NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD CONSTRAINT FK_1D1C63B3CF7BCA0E FOREIGN KEY (service_medical_id) REFERENCES service_medical (id) NOT DEFERRABLE');
    }
